This folder contains the model for running the Iou_Front_update.py and IoU_Top_update.py as follows:
1) Cow_front_name.pt -> front camera cow identity detection model
2) Cow_top_name.pt -> front camera cow identity detection model
