...
# Video input
front_source = "D:\\Project\\YoloV8\\cow\\A03_20240517064400.mp4"
...
def convert_total_to_hms(total_second):
    ...
    flag_date_change = total_second >= 86400
    if flag_date_change:
        total_second %= 86400
...
# Write to CSV
csv_file = (
    f"D:\\Project\\YoloV8\\cow\\cow_behavior_top_IoU_{fileName[4:18]}_{iou_threshold_duplicate}_{iou_threshold_mapping}_TOP.csv"
)
try:
...
file_name = (
    f"D:\\Project\\YoloV8\\cow\\cow_behavior_top_iou_histogram_{fileName[4:18]}_{iou_threshold_duplicate}_{iou_threshold_mapping}.png"
)
